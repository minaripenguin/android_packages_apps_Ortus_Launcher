...
public class HpDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "hp_apps_db";

    private static final String TABLE_NAME = "hp_apps";
    ...
    public static synchronized HpDatabaseHelper getInstance(@NonNull Context context) {
        if (sSingleton == null) {
            sSingleton = new HpDatabaseHelper(context);
        }
