...
class HpAppsAdapter extends RecyclerView.Adapter<HpAppsAdapter.ViewHolder> {
    private List<HpComponent> mList = new ArrayList<>();
    private Listener mListener;
    private boolean mHasSecureKeyguard;

    HpAppsAdapter(Listener listener, boolean hasSecureKeyguard) {
        mListener = listener;
        mHasSecureKeyguard = hasSecureKeyguard;
    }

    public void update(List<HpComponent> list) {
    ...
    public interface Listener {
        void onHiddenItemChanged(@NonNull HpComponent component);

        void onProtectedItemChanged(@NonNull HpComponent component);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(HpComponent component, boolean hasSecureKeyguard) {
        ...
        private void updateProtectedList(int position, HpComponent component) {
            mListener.onProtectedItemChanged(component);
            updateList(position, component);
        }

        private void updateList(int position, HpComponent component) {
